...
<header class="lp-global-header lp-global-header--narrow lp-global-header--no-images" role="banner">
  <div class="lp-global-header__container">
    <div class="lp-global-header__inner js-lp-global-header-inner">
        ...
        <nav class="navigation navigation--narrow navigation--no-images" role="navigation">
          <ul class="navigation__list">
              ...
              <li class="js-nav-item navigation__item navigation__item--active" data-lpa-category="Destinations Next" data-lpa-action="Global Navigation Click" data-lpa-label="Destinations">
               <a class="navigation__link" href="#">Destinations</a>
                ...
                <div class="sub-navigation">
                  <a class="sub-navigation-feature" href="//www.lonelyplanet.com/best-in-asia">
                    <img class="sub-navigation-feature__image" src="https://lonelyplanetstatic.imgix.net/marketing/BIA2016/BIA-nav-image.jpg?w&#x3D;80&amp;h&#x3D;60&amp;fit&#x3D;min" alt="Best in Asia">
                    <div class="sub-navigation-feature__text">
                      <div class="sub-navigation-feature__title">Best in Asia</div>
                  ...
                  <ul class="sub-navigation__list">
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/africa">Africa</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/antarctica-1007062">Antarctica</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/asia">Asia</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/pacific">Australia &amp; Pacific</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/caribbean">Caribbean</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/central-america">Central America</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/europe">Europe</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/middle-east">Middle East</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/north-america">North America</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/south-america">South America</a>
                    </li>
                  </ul>
              ...
              <li class="js-nav-item navigation__item " data-lpa-category="Destinations Next" data-lpa-action="Global Navigation Click" data-lpa-label="Bookings">
               <a class="navigation__link" href="#">Bookings</a>
                ...
                <div class="sub-navigation">
                  ...
                  <ul class="sub-navigation__list">
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/travel-insurance">Insurance</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/hotels">Hotels</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/flights">Flights</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/adventure-tours">Adventure tours</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/sightseeing-tours">Sightseeing tours</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/airport-transfers">Airport transfers</a>
                    </li>
                    <li class="sub-navigation__item">
                      <a class="sub-navigation__link" href="https://www.lonelyplanet.com/car-rental">Car rental</a>
                    </li>
                  </ul>
              ...
              <li class="js-nav-item navigation__item navigation__item--user" data-lpa-category="Destinations Next" data-lpa-action="Global Navigation Click" data-lpa-label="Sign In">
               <a class="navigation__link" href="//auth.lonelyplanet.com/users/sign_in">Sign In</a>
      ...
      <div class="lp-global-header__mobile lp-global-header__mobile--left">
        <a class="lp-global-header__mobile-search js-lp-global-header-search" href="/search">
      ...
      <div class="lp-global-header__mobile lp-global-header__mobile--right js-lp-global-header-mobile">

        <a class="lp-global-header__mobile-menu js-menu" href="#footer">
          <span class="menu-icon" aria-label="Menu"></span>
        </a>
      </div>
