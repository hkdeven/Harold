export default function coverVid(elem, width, height) {
	...
	let posterImage = elem.getAttribute("poster");
	...
	function sizeVideo() {
		...
		let parentHeight = elem.parentNode.offsetHeight;
		let parentWidth = elem.parentNode.offsetWidth;
